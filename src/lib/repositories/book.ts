...
import type { DeleteBookRequestParams } from "@/lib/schema/api/books/DeleteBookRequestParams";
import type { DeleteBookResponse } from "@/lib/schema/api/books/DeleteBookResponse";
...
import type { PatchBookRequestBody } from "@/lib/schema/api/books/PatchBookRequestBody";
import type { PatchBookRequestParams } from "@/lib/schema/api/books/PatchBookRequestParams";
import type { PatchBookResponse } from "@/lib/schema/api/books/PatchBookResponse";
import type { PostBookRequestBody } from "@/lib/schema/api/books/PostBookRequestBody";
import type { PostBookResponse } from "@/lib/schema/api/books/PostBookResponse";
import {
  author,
  book,
  episode,
  ...
  async delete(options: {
    ...
    try {
      getDatabase().transaction(async (tx) => {
        ...
        await tx
          .delete(feature)
          .where(eq(feature.bookId, options.params.bookId))
          .execute();
        await tx
          .delete(ranking)
          .where(eq(ranking.bookId, options.params.bookId))
          .execute();
