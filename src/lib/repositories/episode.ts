...
import type { DeleteEpisodeRequestParams } from "@/lib/schema/api/episodes/DeleteEpisodeRequestParams";
import type { DeleteEpisodeResponse } from "@/lib/schema/api/episodes/DeleteEpisodeResponse";
...
import type { PatchEpisodeRequestBody } from "@/lib/schema/api/episodes/PatchEpisodeRequestBody";
import type { PatchEpisodeRequestParams } from "@/lib/schema/api/episodes/PatchEpisodeRequestParams";
import type { PatchEpisodeResponse } from "@/lib/schema/api/episodes/PatchEpisodeResponse";
import type { PostEpisodeRequestBody } from "@/lib/schema/api/episodes/PostEpisodeRequestBody";
import type { PostEpisodeResponse } from "@/lib/schema/api/episodes/PostEpisodeResponse";
import { episode, episodePage } from "@/lib/schema/models";

import { getDatabase } from "../database/drizzle";

type EpisodeRepositoryInterface = {
  create(options: {
    body: PostEpisodeRequestBody;
  }): Promise<Result<PostEpisodeResponse, HTTPException>>;
  delete(options: {
    params: DeleteEpisodeRequestParams;
  ...
  async delete(options: {
    ...
    try {
      await getDatabase().transaction(async (tx) => {
        ...
        await tx
          .delete(episodePage)
          .where(eq(episodePage.episodeId, options.params.episodeId))
          .execute();
      });
